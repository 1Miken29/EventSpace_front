    ...
    <>
      <header className="px-11 py-[18px] flex flex-row justify-between items-center">
              ...
              <div className="flex flex-row gap-[70px] mx-8">
                <button className="flex flex-col cursor-pointer justify-center items-center text-[#8B5DFF]" onClick={handleSalones}>
                  <IconlyHomeBold color="#8B5DFF" />
                  Salones
                </button>
                <button className="flex flex-col cursor-pointer justify-center items-center" onClick={handlePerfil}>
                  <IconlyProfile />
                  Perfil
                </button>
              </div>
      ...
      <div className="flex flex-col justify-center items-center h-screen font-medium">
        ...
        <button onClick={handleRegister} className="underline text-[#8B5DFF] cursor-pointer">
          Registrar un salón
        </button>
      </div>
    </>
