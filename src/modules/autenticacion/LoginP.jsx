  ...
  return (
    <div className="flex flex-col md:flex-row h-screen">
      ...
      <div className="w-full md:w-1/2 bg-white p-4 md:p-8 lg:p-16 xl:p-30 overflow-hidden">
        <div className="max-w-xl mx-auto">
          ...
          <ul className="space-y-3 md:space-y-6 mb-4 md:mb-8">
            ...
            <li className="font-Outfit text-lg md:text-xl lg:text-[24px] leading-relaxed">
              Completa tu perfil y comparte tus propiedades para conectar con
              más clientes.
            </li>
          </ul>
        </div>
      ...
      <div className="w-full md:w-1/2 bg-[#c3b6e3] flex items-center justify-center p-4">
        <div
          className="w-full max-w-sm space-y-4 bg-white p-4 md:p-6 lg:p-8 rounded-2xl mx-auto"
        ...
        >
          ...
          <form onSubmit={handleLoginP}>
            <div className="flex flex-col space-y-4">
              ...
              <a href="#" className="text-center" onClick={handleContraP}>
                ¿Olvidaste tu contraseña?
              </a>
              <button className="w-full bg-blue-500 text-white py-4 px-4 rounded-full hover:bg-blue-700">
                Iniciar Sesión
              </button>
